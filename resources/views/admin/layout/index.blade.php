			...
			<div class="sidebar-content">
					...
					<div class="card-body">
						<div class="media">
							...
							<div class="media-body">
								...
								<div class="font-size-xs opacity-50">{{App\Models\Information::siteName()}}
								</div>
							</div>
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu {{Request::is('admin/product*')?'nav-item-open':''}}">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Layouts" style="{{Request::is('user/product*')?'display:block':''}}">
								<li class="nav-item"><a href="{{route('admin.product.create')}}" class="nav-link {{Request::is('admin/product.create')?'active':''}}">Add Products</a></li>
								<li class="nav-item"><a href="{{route('admin.product.index')}}" class="nav-link {{Request::is('admin/product')?'active':''}}">Manage</a></li>
								{{-- <li class="nav-item"><a href="{{route('admin.order.orders')}}" class="nav-link {{Request::is('admin/orders')?'active':''}}">Your Orders</a></li> --}}
							</ul>
						</li>
						<li class="nav-item">
